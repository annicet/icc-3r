...
export const TopTabBar: React.FC<Props> = ({ state, descriptors, navigation }: Props) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={{
                ...
                backgroundColor: isFocused ? theme.colors.primary : 'rgba(255,255,255,0.5)'
              }}
            >
              <Text
                style={{
                  fontSize: theme.size.normal,
                  color: isFocused ? theme.colors.invertedTextColor : theme.colors.text
                }}
              >
                {t(label.toString())}
              </Text>
